...
namespace SNSMessageExampleTest
{
    public class SNSMessageTest
    {
        ...
        //private readonly string PhoneNum = ConfigurationManager.AppSettings["PhoneNum"];
        //private readonly string PhoneNum = "18005551212";
        private readonly string PhoneNum = "NotifService";
		

        private AmazonSimpleNotificationServiceClient CreateMockSNSClient()
        {

		// string PhoneNum = ConfigurationManager.AppSettings["PhoneNum"];
